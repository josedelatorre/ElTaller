...
public class Taller {
	...
	public void reparar(){
		...
		System.out.print("Matricula del veh�culo a reparar: ");
		...
		//Si se encuentra, que comience la reparaci�n.
		if(vReparar != null){
	...
	private int mostrarMenuInsertar() {
		...
		System.out.println("�Qu� desea crear?: ");
		return sc.nextInt();
	...
	private void aniadirVehiculoAveriado(Vehiculo v) {
		if (!this.listaAveriados.contains(v)) {
			...
			System.out.println("[ERROR] El vehiculo " + v.getMatricula() + " ya est� en el taller!!!");
		}
	}
	...
	private void repararVehiculo(Vehiculo v, int opcion){
		...
		case 5:
			...
			break;
		case 6:
			System.out.println("[CONFIRMACI�N] �Quieres marcar el vehiculo "+ v.getMatricula() + " como reparado?");
